  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="bg-white rounded-2xl shadow-xl border border-pink-100 p-8 md:p-12 text-center max-w-xl w-full">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center mx-auto mb-6 shadow-md shadow-pink-100">
        ...
        <Button variant="pink" size="xl" className="w-full flex items-center justify-center gap-2 text-base font-bold shadow-lg shadow-pink-200" asChild>
